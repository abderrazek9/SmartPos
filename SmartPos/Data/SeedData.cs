...
public static class SeedData
{
    ...
    public static List<MenuItem> GetMenuItems()
    {
        ...
        {  
            ...
            new MenuItem { Id = 12, Name = "طماطم مصبرة", Icon = "tomato.png", Description = "علبة 400 جرام", Price = 180, StockQuantity = 30 },
            new MenuItem { Id = 13, Name = "سردين معلب", Icon = "sardines.png", Description = "علبة 125 جرام", Price = 320, StockQuantity = 30 },
            new MenuItem { Id = 14, Name = "لحم مجمد", Icon = "frozen_meat.png", Description = "كيلو لحم مستورد", Price = 1250, StockQuantity = 30 },
            new MenuItem { Id = 15, Name = "دجاج مجمد", Icon = "frozen_chicken.png", Description = "دجاجة كاملة 1.2 كجم", Price = 300, StockQuantity = 30 },

            // 🥛 منتجات الألبان (16-20)
            new MenuItem { Id = 16, Name = "لبن طبيعي", Icon = "yogurt.png", Description = "علبة 500 جرام", Price = 100, StockQuantity = 30 },
            new MenuItem { Id = 17, Name = "جبن مثلثات", Icon = "cheese_triangles.png", Description = "علبة 8 قطع", Price = 160, StockQuantity = 30 },
            new MenuItem { Id = 18, Name = "زبدة", Icon = "butter.png", Description = "عبوة 250 جرام", Price = 220, StockQuantity = 30 },
            new MenuItem { Id = 19, Name = "جبن رومي", Icon = "cheese.png", Description = "200 جرام", Price = 450, StockQuantity = 30 },
            new MenuItem { Id = 20, Name = "حليب بودرة", Icon = "powdered_milk.png", Description = "علبة 500 جرام", Price = 560, StockQuantity = 30 },

            // 🍫 الوجبات الخفيفة (21-25)
            new MenuItem { Id = 21, Name = "بسكويت", Icon = "biscuit.png", Description = "علبة 300 جرام", Price = 200, StockQuantity = 30 },
            new MenuItem { Id = 22, Name = "شوكولاتة", Icon = "chocolate.png", Description = "لوح 100 جرام", Price = 250 , StockQuantity = 30},
            new MenuItem { Id = 23, Name = "مكسرات", Icon = "nuts.png", Description = "كيس 250 جرام", Price = 580 , StockQuantity = 30},
            new MenuItem { Id = 24, Name = "رقائق البطاطس", Icon = "chips.png", Description = "كيس 150 جرام", Price = 190 , StockQuantity = 30},
            new MenuItem { Id = 25, Name = "علكة", Icon = "gum.png", Description = "عبوة 10 قطع", Price = 75 , StockQuantity = 30},

            // 🧼 مواد التنظيف (26-30)
            new MenuItem { Id = 26, Name = "صابون سائل", Icon = "soap.png", Description = "عبوة 1 لتر", Price = 250 , StockQuantity = 30},
            new MenuItem { Id = 27, Name = "مسحوق غسيل", Icon = "detergent.png", Description = "كيس 3 كجم", Price = 575 , StockQuantity = 30},
            new MenuItem { Id = 28, Name = "معطر جو", Icon = "air_freshener.png", Description = "عبوة 300 مل", Price = 350 , StockQuantity = 30},
            new MenuItem { Id = 29, Name = "إسفنج أطباق", Icon = "sponge.png", Description = "عبوة 5 قطع", Price = 120 , StockQuantity = 30},
            new MenuItem { Id = 30, Name = "مناديل ورقية", Icon = "tissue.png", Description = "رزمة 150 ورقة", Price = 180 , StockQuantity = 30}
        };
    }
